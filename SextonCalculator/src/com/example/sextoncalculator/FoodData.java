...
public class FoodData extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		String createSql = "CREATE TABLE " + TABLE_NAME + " (" + ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + NAME + " TEXT NOT NULL, " + CALORIES + " INTEGER NOT NULL, " + PRICE + " REAL NOT NULL, " + CATEGORY + " INTEGER NOT NULL);"; 
		db.execSQL(createSql);
	}
	...
	public void insert(String name, int calories, double price, int category){
